...
<header class="top-bar">
  <div class="brand-group"><strong class="brand">Kenzie<span>Dashboard</span></strong><span class="project-pill">Default Project</span><button class="header-icon" class:dark-mode={$globalThemeMode === 'dark'} aria-label={$globalThemeMode === 'dark' ? 'Switch to light mode' : 'Switch to dark mode'} aria-pressed={$globalThemeMode === 'dark'} title={$globalThemeMode === 'dark' ? 'Switch to light mode' : 'Switch to dark mode'} on:click={toggleGlobalTheme}><img src={`/tmp-icons/${$globalThemeMode === 'dark' ? 'sun' : 'moon'}.svg`} alt="" /></button><button class="header-icon" aria-label="Privacy"><img src="/tmp-icons/obfuscation.svg" alt="" /></button><button class="header-icon" aria-label="Settings" on:click={toggleSettings}><img src="/tmp-icons/settings-cog.svg" alt="" /></button><button class="header-icon" aria-label="Sync"><img src="/tmp-icons/sync.svg" alt="" /></button><button class="header-icon" aria-label="Start timer"><img src="/tmp-icons/play.svg" alt="" /></button></div>
  ...
  <div class="top-actions">
    ...
    <PrivacyControl />
    <button class="control-button" aria-label="Open settings" on:click={toggleSettings}><img src="/tmp-icons/settings-cog.svg" alt="" /></button>
  </div>
</header>
