<script lang="ts">
  ...
  import ScopeToggle from '../components/ScopeToggle.svelte'; import { docsScope, showArchivedDocs, selectedDocTags, visibleDocuments, allDocTags, openDocument, createDocument, toggleDocTag, loadDocuments, updateDocument, deleteDocument } from '../documents/state';
...
<div class="focus-panel">
  <div class="panel-heading"><h2>Docs</h2><div>
    <ScopeToggle scope={$docsScope} onChange={(value) => docsScope.set(value)} />
